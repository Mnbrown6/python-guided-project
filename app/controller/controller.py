...
from app.models.paralellogram import Parallelogram
...
def process_square(sq: Square):
    ...
    print(f'This perimeter of this square is {precision_value(sq.perimeter)}')
    print(f'This area of this square is {precision_value(sq.area)}')


def process_rectangle(rect: Rectangle):
    print(f'The height of this rectangle is {precision_value(rect.height)}')
    print(f'This perimeter of this rectangle is {precision_value(rect.perimeter)}')
    print(f'This area of this rectangle is {precision_value(rect.area)}')
